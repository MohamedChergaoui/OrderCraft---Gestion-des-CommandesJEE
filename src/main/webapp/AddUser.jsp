...
<div class="h-full flex">
    ...
    <div class="flex flex-col min-w-0 flex-1 overflow-hidden">
        ...
        <div class="flex-1 relative z-0 flex overflow-hidden">
            <main class="flex-1 relative z-0 overflow-y-auto focus:outline-none">
                <section class="max-w-4xl p-6 mx-auto bg-white rounded-md shadow-xl dark:bg-indigo-600 mt-20">
                    ...
                    <form method="post" action="AddUser.java">
                        <div class="grid grid-cols-1 gap-6 mt-4 sm:grid-cols-2">
                            ...
                            <div>
                                ...
                                <input id="emailAddress" name="email" type="email" class="block w-full px-4 py-2 mt-2 text-gray-700 bg-white border border-gray-300 rounded-md dark:bg-gray-800 dark:text-gray-300 dark:border-gray-600 focus:border-blue-500 dark:focus:border-blue-500 focus:outline-none focus:ring">
                            </div>
        ...
        <div class="flex justify-end mt-6">
            <button class="px-6 py-2 leading-5 text-white transition-colors duration-200 transform bg-indigo-600 rounded-md hover:bg-indigo-600 focus:outline-none focus:bg-gray-600" type="submit">Add</button>
        </div>
        </form>
        </section>
