                        ...
                        <div class="px-4 sm:px-6 lg:px-8">
                            <div class="sm:flex sm:items-center">
                                ...
                                <div class="mt-4 sm:mt-0 sm:ml-16 sm:flex-none">
                                    <a href="AddUser.jsp" class="inline-flex items-center justify-center rounded-md border border-transparent bg-indigo-600 px-4 py-2 text-sm font-medium text-white shadow-sm hover:bg-indigo-700 focus:outline-none focus:ring-2 focus:ring-indigo-500 focus:ring-offset-2 sm:w-auto">Add user</a>
                                </div>
                            </div>
                                    ...
                                    <div class="inline-block min-w-full py-2 align-middle md:px-6 lg:px-8">
                                        <div class="overflow-hidden shadow ring-1 ring-black ring md:rounded-lg">
                                            <table class="min-w-full divide-y divide-gray-500">
                                                ...
                                                <%for (User user : Users) {%>
                                                <tr>
                                                    <td class="whitespace-nowrap py-4 pl-4 pr-3 text-sm font-medium text-gray-900 sm:pl-6"><%= user.getId() %></td>
                                                    <td class="whitespace-nowrap px-3 py-4 text-sm text-gray-500"><%= user.getName() %></td>
                                                    <td class="whitespace-nowrap px-3 py-4 text-sm text-gray-500"><%= user.getPrenom() %></td>
                                                    <td class="whitespace-nowrap px-3 py-4 text-sm text-gray-500"><%= user.getEmail() %></td>
                                                    <td class="whitespace-nowrap px-3 py-4 text-sm text-gray-500"><%= user.getRole() %></td>
                                                    <td class="whitespace-nowrap px-3 py-4 text-sm text-gray-500">
                                                        <a href="EditUser.java?id=<%= user.getId() %>" >
                                                        ...
                                                        <a href="DeleteUser.java?id=<%=user.getId() %>" >
                                                            <button type="button" class="inline-flex items-center justify-center rounded-md border border-transparent bg-indigo-600 px-4 py-2 text-sm font-medium text-white shadow-sm hover:bg-indigo-700 focus:outline-none focus:ring-2 focus:ring-indigo-500 focus:ring-offset-2 sm:w-auto">
                                                                Delete
                                                            </button>
                                                           <span class="sr-only">, Lindsay Walton</span></a>
