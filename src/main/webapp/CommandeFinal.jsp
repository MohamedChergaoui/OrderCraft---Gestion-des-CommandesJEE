...
<%@ page import="com.example.apprendejee.LingneCommande.ILigne_Commande" %>
<%@ page import="com.example.apprendejee.LingneCommande.LigneCommandeImpl" %>
...
<head>
  ...
  <%
    ...
    List<Product> Products=(List<Product>)session.getAttribute("productOfCommande") ;
    String name="";
    String role="";
  ...
  <div class="flex flex-col min-w-0 flex-1 overflow-hidden">
    ...
    <div class="">
      <main class="">
          ...
          <h3 class="mb-5 text-lg font-medium text-gray-900 dark:text-white">All  Product </h3>
        ...
        <a href="StatusFinal.Commande?id=<%=id_commande%>" >
