                        ...
                        <div class="px-4 sm:px-6 lg:px-8">
                            <div class="sm:flex sm:items-center">
                                <div class="sm:flex-auto">
                                    ...
                                    <p class="mt-2 text-sm text-gray-700">A list of all the Clients in your account including their name, prenom, adresse and Phone.</p>
                                </div>
                                <div class="mt-4 sm:mt-0 sm:ml-16 sm:flex-none">
                                    <a href="AddClient.jsp" class="inline-flex items-center justify-center rounded-md border border-transparent bg-indigo-600 px-4 py-2 text-sm font-medium text-white shadow-sm hover:bg-indigo-700 focus:outline-none focus:ring-2 focus:ring-indigo-500 focus:ring-offset-2 sm:w-auto">Add Client</a>
                                </div>
                            </div>
                                    ...
                                    <div class="inline-block min-w-full py-2 align-middle md:px-6 lg:px-8">
                                        <div class="overflow-hidden shadow ring-1 ring-black ring md:rounded-lg">
                                            <table class="min-w-full divide-y divide-gray-500">
                                                ...
                                                <tr>
                                                    <td class="whitespace-nowrap py-4 pl-4 pr-3 text-sm font-medium text-gray-900 sm:pl-6"><%= client.getId() %></td>
                                                    <td class="whitespace-nowrap px-3 py-4 text-sm text-gray-500"><%=client.getName() %></td>
                                                    <td class="whitespace-nowrap px-3 py-4 text-sm text-gray-500"><%=client.getPrenom() %></td>
                                                    <td class="whitespace-nowrap px-3 py-4 text-sm text-gray-500"><%=client.getAdresse() %></td>
                                                    <td class="whitespace-nowrap px-3 py-4 text-sm text-gray-500"><%=client.getTele() %></td>
                                                    <td class="whitespace-nowrap px-3 py-4 text-sm text-gray-500">
                                                        <a href="EditClient.Client?id=<%=client.getId()%>" >
                                                        ...
                                                        <a href="DeleteClient.Client?id=<%=client.getId() %>" >
                                                            <button type="button" class="inline-flex items-center justify-center rounded-md border border-transparent bg-indigo-600 px-4 py-2 text-sm font-medium text-white shadow-sm hover:bg-indigo-700 focus:outline-none focus:ring-2 focus:ring-indigo-500 focus:ring-offset-2 sm:w-auto">
                                                                Delete
                                                            </button>
                                                            <span class="sr-only">, Lindsay Walton</span></a>
