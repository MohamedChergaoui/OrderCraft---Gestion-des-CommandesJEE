        ...
        <div class="flex-1 relative z-0 flex overflow-hidden">
            <main class="flex-1 relative z-0 overflow-y-auto focus:outline-none">
                <section class="max-w-4xl p-6 mx-auto bg-white rounded-md shadow-xl dark:bg-indigo-600 mt-20">
                    ...
                    <form method="post" action="SaveClient.Client">
                        <div class="grid grid-cols-1 gap-6 mt-4 sm:grid-cols-2">
                            <div>
                                <label class=" text-gray-800" for="username">ID</label>
                                <input id="id" name ="id" hidden  value ="<%=client.getId()%>"  readonly type ="text" class="block w-full px-4 py-2 mt-2 text-gray-700 bg-white border border-gray-300 rounded-md dark:bg-gray-800 dark:text-gray-300 dark:border-gray-600 focus:border-blue-500 dark:focus:border-blue-500 focus:outline-none focus:ring">
                            </div>
                            <div>
                                <label class=" text-gray-800" for="username">FirstName</label>
                                <input id="username" name ="nom" value ="<%=client.getName()%>" type ="text" class="block w-full px-4 py-2 mt-2 text-gray-700 bg-white border border-gray-300 rounded-md dark:bg-gray-800 dark:text-gray-300 dark:border-gray-600 focus:border-blue-500 dark:focus:border-blue-500 focus:outline-none focus:ring">
                            </div>
                            <div>
                                <label class="text-gray-800" for="LastName">LastName</label>
                                <input id="LastName" name = "Prenom" value ="<%= client.getPrenom()%>" type ="text" class="block w-full px-4 py-2 mt-2 text-gray-700 bg-white border border-gray-300 rounded-md dark:bg-gray-800 dark:text-gray-300 dark:border-gray-600 focus:border-blue-500 dark:focus:border-blue-500 focus:outline-none focus:ring">
                            </div>

                            <div>
                                <label class=" text-gray-800" for="emailAddress"> Address</label>
                                <input id="emailAddress" name="adress" type="text" value ="<%= client.getAdresse()%>"  class="block w-full px-4 py-3 mt-2 text-gray-700 bg-white border border-gray-300 rounded-md dark:bg-gray-800 dark:text-gray-300 dark:border-gray-600 focus:border-blue-500 dark:focus:border-blue-500 focus:outline-none focus:ring">
                            </div>

                            <div>
                                <label class="text-gray-800" for="password">Phone</label>
                                <input id="password" type="text" name="tele" value ="<%=client.getTele()%>"class="block w-full px-4 py-2 mt-2 text-gray-700 bg-white border border-gray-300 rounded-md dark:bg-gray-800 dark:text-gray-300 dark:border-gray-600 focus:border-blue-500 dark:focus:border-blue-500 focus:outline-none focus:ring">
                            </div>
